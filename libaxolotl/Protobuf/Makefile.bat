...
ProtoGen -namespace="libaxolotl.fingerprint" -umbrella_classname="FingerprintProtos" -nest_classes=true -output_directory="../fingerprint/" FingerprintProtocol.proto