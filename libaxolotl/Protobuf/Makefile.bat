...
ProtoGen -namespace="libaxolotl.state" -umbrella_classname="StorageProtos" -nest_classes=true -output_directory="../state/" LocalStorageProtocol.proto FingerprintProtocol.proto
